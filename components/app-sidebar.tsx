...
const insightItems = [
  ...
  { title: "Resources", href: "/api/resources", icon: DatabaseZap },
]
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild size="lg">
              <Link href="/dashboard">
                <div className="flex size-10 items-center justify-center rounded-xl bg-linear-to-br from-blue-500 to-cyan-400 text-white shadow-sm">
